...
export PICK_CUBE_SOURCE=umi_0828_0902
export PICK_CUBE_TASK=umi
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_umi_zarr/pick_cube_0828_0902_1cam/dataset.zarr.zip}
export PICK_CUBE_IGNORE_PROPRIOCEPTION=false
export PICK_CUBE_DATASET_FREQUENCY=${DATASET_FREQUENCY:-19.99976037822913}
...
export PICK_CUBE_RUN_TAG=pick_cube_0828_0902_umi_1cam_ds1_with_state
