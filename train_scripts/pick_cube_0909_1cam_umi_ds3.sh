...
export PICK_CUBE_SOURCE=umi_0909
export PICK_CUBE_TASK=umi
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_umi_zarr/pick_cube_0909_1cam/dataset.zarr.zip}
export PICK_CUBE_IGNORE_PROPRIOCEPTION=false
export PICK_CUBE_DATASET_FREQUENCY=${DATASET_FREQUENCY:-60.0}
...
export PICK_CUBE_RUN_TAG=pick_cube_0909_umi_1cam_ds3_with_state
