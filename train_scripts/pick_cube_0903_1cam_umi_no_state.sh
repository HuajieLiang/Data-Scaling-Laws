...
export PICK_CUBE_SOURCE=umi_0903
export PICK_CUBE_TASK=umi
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_umi_zarr/pick_cube_0903_1cam/dataset.zarr.zip}
...
export PICK_CUBE_RUN_TAG=pick_cube_0903_umi_1cam_no_state
