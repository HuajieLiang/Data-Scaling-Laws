...
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_real_zarr/pick_cube_1cam/dataset.zarr.zip}
...
export PICK_CUBE_RUN_TAG=pick_cube_real_1cam_with_state
