...
export PICK_CUBE_SOURCE=mix_real_all_umi_all
export PICK_CUBE_TASK=umi
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_mix_zarr/pick_cube_1cam_real_all_umi_all/dataset.zarr.zip}
...
export PICK_CUBE_DATASET_FREQUENCY=${DATASET_FREQUENCY:-20.663228874678968}
...
export PICK_CUBE_RUN_TAG=pick_cube_mix_real_all_umi_all_1cam_with_state
