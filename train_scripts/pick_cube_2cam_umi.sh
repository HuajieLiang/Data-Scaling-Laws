...
export PICK_CUBE_DATASET_PATH=${DATASET_PATH:-data/dataset_umi_zarr/pick_cube_trim2s_2cam/dataset.zarr.zip}
...
export PICK_CUBE_RUN_TAG=pick_cube_trim2s_umi_2cam_with_state
